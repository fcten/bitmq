...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/webit: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/webit ${OBJECTFILES} ${LDLIBSOPTIONS} -lssl -lcrypto -pg -ldl -lz

${OBJECTDIR}/src/bmtp/wbt_bmtp.o: src/bmtp/wbt_bmtp.c 
	${MKDIR} -p ${OBJECTDIR}/src/bmtp
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bmtp/wbt_bmtp.o src/bmtp/wbt_bmtp.c

${OBJECTDIR}/src/bmtp/wbt_bmtp_sid.o: src/bmtp/wbt_bmtp_sid.c 
	${MKDIR} -p ${OBJECTDIR}/src/bmtp
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bmtp/wbt_bmtp_sid.o src/bmtp/wbt_bmtp_sid.c
...
${OBJECTDIR}/src/common/wbt_crc.o: src/common/wbt_crc.c 
	${MKDIR} -p ${OBJECTDIR}/src/common
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/common/wbt_crc.o src/common/wbt_crc.c
...
${OBJECTDIR}/src/common/wbt_gzip.o: src/common/wbt_gzip.c 
	${MKDIR} -p ${OBJECTDIR}/src/common
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/common/wbt_gzip.o src/common/wbt_gzip.c
...
${OBJECTDIR}/src/http/wbt_http_mq.o: src/http/wbt_http_mq.c 
	${MKDIR} -p ${OBJECTDIR}/src/http
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/http/wbt_http_mq.o src/http/wbt_http_mq.c
...
${OBJECTDIR}/src/mq/wbt_mq_dlq.o: src/mq/wbt_mq_dlq.c 
	${MKDIR} -p ${OBJECTDIR}/src/mq
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mq/wbt_mq_dlq.o src/mq/wbt_mq_dlq.c
