...
${OBJECTDIR}/src/common/wbt_config.o: src/common/wbt_config.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -Isrc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/wbt_config.o src/common/wbt_config.c

${OBJECTDIR}/src/common/wbt_connection.o: src/common/wbt_connection.c 
	${MKDIR} -p ${OBJECTDIR}/src/common
	${RM} $@.d
	$(COMPILE.c) -g -Isrc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/wbt_connection.o src/common/wbt_connection.c

${OBJECTDIR}/src/common/wbt_event.o: src/common/wbt_event.c 
	${MKDIR} -p ${OBJECTDIR}/src/common
	${RM} $@.d
	$(COMPILE.c) -g -Isrc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/wbt_event.o src/common/wbt_event.c

${OBJECTDIR}/src/common/wbt_file.o: src/common/wbt_file.c 
	${MKDIR} -p ${OBJECTDIR}/src/common
	${RM} $@.d
	$(COMPILE.c) -g -Isrc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/wbt_file.o src/common/wbt_file.c

${OBJECTDIR}/src/common/wbt_heap.o: src/common/wbt_heap.c 
	${MKDIR} -p ${OBJECTDIR}/src/common
	${RM} $@.d
	$(COMPILE.c) -g -Isrc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/wbt_heap.o src/common/wbt_heap.c

${OBJECTDIR}/src/common/wbt_list.o: src/common/wbt_list.c 
	${MKDIR} -p ${OBJECTDIR}/src/common
	${RM} $@.d
	$(COMPILE.c) -g -Isrc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/wbt_list.o src/common/wbt_list.c

${OBJECTDIR}/src/common/wbt_log.o: src/common/wbt_log.c 
	${MKDIR} -p ${OBJECTDIR}/src/common
	${RM} $@.d
	$(COMPILE.c) -g -Isrc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/wbt_log.o src/common/wbt_log.c

${OBJECTDIR}/src/common/wbt_memory.o: src/common/wbt_memory.c 
	${MKDIR} -p ${OBJECTDIR}/src/common
	${RM} $@.d
	$(COMPILE.c) -g -Isrc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/wbt_memory.o src/common/wbt_memory.c

${OBJECTDIR}/src/common/wbt_module.o: src/common/wbt_module.c 
	${MKDIR} -p ${OBJECTDIR}/src/common
	${RM} $@.d
	$(COMPILE.c) -g -Isrc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/wbt_module.o src/common/wbt_module.c

${OBJECTDIR}/src/common/wbt_rbtree.o: src/common/wbt_rbtree.c 
	${MKDIR} -p ${OBJECTDIR}/src/common
	${RM} $@.d
	$(COMPILE.c) -g -Isrc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/wbt_rbtree.o src/common/wbt_rbtree.c

${OBJECTDIR}/src/common/wbt_string.o: src/common/wbt_string.c 
	${MKDIR} -p ${OBJECTDIR}/src/common
	${RM} $@.d
	$(COMPILE.c) -g -Isrc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/wbt_string.o src/common/wbt_string.c

${OBJECTDIR}/src/common/wbt_time.o: src/common/wbt_time.c 
	${MKDIR} -p ${OBJECTDIR}/src/common
	${RM} $@.d
	$(COMPILE.c) -g -Isrc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/wbt_time.o src/common/wbt_time.c

${OBJECTDIR}/src/http/wbt_http.o: src/http/wbt_http.c 
	${MKDIR} -p ${OBJECTDIR}/src/http
	${RM} $@.d
	$(COMPILE.c) -g -Isrc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/http/wbt_http.o src/http/wbt_http.c
...
${OBJECTDIR}/src/os/linux/wbt_sigsegv.o: src/os/linux/wbt_sigsegv.c 
	${MKDIR} -p ${OBJECTDIR}/src/os/linux
	${RM} $@.d
	$(COMPILE.c) -g -Isrc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/os/linux/wbt_sigsegv.o src/os/linux/wbt_sigsegv.c

${OBJECTDIR}/src/os/linux/wbt_terminal.o: src/os/linux/wbt_terminal.c 
	${MKDIR} -p ${OBJECTDIR}/src/os/linux
	${RM} $@.d
	$(COMPILE.c) -g -Isrc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/os/linux/wbt_terminal.o src/os/linux/wbt_terminal.c

${OBJECTDIR}/src/webit.o: src/webit.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -Isrc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/webit.o src/webit.c
